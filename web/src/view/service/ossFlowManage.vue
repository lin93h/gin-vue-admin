  ...
  <div class="service-vm-wrapper">
    <el-table :data="tableData" border max-height="500px">
      <el-table-column>
        ...
        <el-table-column label="用户编号" prop="" width="140"></el-table-column>
        <el-table-column label="所属空间" prop=""></el-table-column>
        <el-table-column label="所属空间编号" prop=""></el-table-column>
        <el-table-column label="区域" prop=""></el-table-column>
        <el-table-column label="区域编号" prop=""></el-table-column>
        <el-table-column label="流量包大小(单位GB)" prop="" width="180"></el-table-column>
        <el-table-column label="购买时间" prop=""></el-table-column>
        <el-table-column label="操作" width="200" align="center" fixed="right">
          <template #default="{ row }">
            <el-button type="success" size="small">购买详情</el-button>
          </template>
        </el-table-column>
      </el-table-column>
    </el-table>
