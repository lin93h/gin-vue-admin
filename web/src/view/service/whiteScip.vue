      ...
      <el-table-column>
        <template #header>
          <div class="table-top-bar">
            ...
            <section class="right">
              <el-button type="success">添加监控IP</el-button>
              <el-button type="primary">同步IP段</el-button>
        ...
        <el-table-column label="子网掩码位数" prop="" width="140"></el-table-column>
        <el-table-column label="添加人" prop=""></el-table-column>
