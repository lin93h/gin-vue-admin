...
<template>
  <div class="service-vm-wrapper">
    <fieldset ref="demo1">
      <legend>所属节点</legend>
      <el-radio-group v-model="searchParams.nuuid">
    ...
    <el-table :data="tableData" border max-height="500px">
      <el-table-column>
        ...
        <el-table-column label="cpu" prop=""></el-table-column>
        <el-table-column label="内存" prop=""></el-table-column>
        <el-table-column label="计费" prop=""></el-table-column>
        <el-table-column label="配置" prop=""></el-table-column>
        <el-table-column label="网络" prop=""></el-table-column>
