  ...
  <div class="service-vm-wrapper">
    <el-table :data="tableData" @selection-change="handleSelectionChange" border max-height="500px">
      <el-table-column>
        ...
        <el-table-column label="区域名称" prop="" width="140"></el-table-column>
        <el-table-column label="区域编号" prop=""></el-table-column>
        <el-table-column label="url接口地址" prop=""></el-table-column>
        <el-table-column label="access/secreKey" prop=""></el-table-column>
        <el-table-column label="备注" prop=""></el-table-column>
        <el-table-column label="操作" width="200" align="center" fixed="right">
          <template #default="{ row }">
            <el-button type="success" size="small">区域详情</el-button>
            <el-button type="warning" size="small">修改区域</el-button>
          </template>
        </el-table-column>
      </el-table-column>
    </el-table>
